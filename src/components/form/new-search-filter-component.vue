    ...
    <div class="searchFormWrap fl-bet-cen fl-wrap">
      <div class="fl-sta-cen">
        ...
        >
          ...
          <!-- <el-button type="primary" @click="searchHandle" v-if="btnVisible">{{ $t('common.search_btn') }}</el-button> -->
        </el-form>
      </div>
...
<script>
import FilterTag from "@/components/form/new-filter-tag-component.vue";
...
.searchWrap .el-range-editor--small.el-input__inner {
  height: 36px;
}
